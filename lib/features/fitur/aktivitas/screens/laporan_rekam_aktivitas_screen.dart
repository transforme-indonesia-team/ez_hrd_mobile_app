...
class LaporanRekamAktivitasScreen extends StatefulWidget {
  const LaporanRekamAktivitasScreen({super.key});

  @override
  State<LaporanRekamAktivitasScreen> createState() => _LaporanRekamAktivitasScreenState();
}

class _LaporanRekamAktivitasScreenState extends State<LaporanRekamAktivitasScreen> {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            // Tipe Aktivitas
            _buildLabel(colors, 'Tipe Aktivitas'),
            GestureDetector(
              onTap: () {},
              child: _buildFieldContainer(
                colors,
