...
class LaporanKehadiranWajahYangDicurigaiScreen extends StatefulWidget {
  const LaporanKehadiranWajahYangDicurigaiScreen({super.key});

  @override
  State<LaporanKehadiranWajahYangDicurigaiScreen> createState() =>
      _LaporanKehadiranWajahYangDicurigaiScreenState();
}

class _LaporanKehadiranWajahYangDicurigaiScreenState
    extends State<LaporanKehadiranWajahYangDicurigaiScreen> {
  ...
  void _showPratinjauBottomSheet() {
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              ListTile(
                leading: Icon(Icons.open_in_new, color: colors.textSecondary),
                title: Text('Pratinjau Kalender',
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          'Laporan Kehadiran Wajah yang Dicurigai',
      ...
      children: [
        Expanded(
          child: _buildButtonItem(
            ...
            onTap: _showPratinjauBottomSheet,
          ),
        ),
        SizedBox(width: 8.w),
        Expanded(
