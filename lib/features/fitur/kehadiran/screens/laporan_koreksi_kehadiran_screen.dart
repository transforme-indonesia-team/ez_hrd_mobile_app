...
class LaporanKoreksiKehadiranScreen extends StatefulWidget {
  const LaporanKoreksiKehadiranScreen({super.key});

  @override
  State<LaporanKoreksiKehadiranScreen> createState() =>
      _LaporanKoreksiKehadiranScreenState();
}

class _LaporanKoreksiKehadiranScreenState
    extends State<LaporanKoreksiKehadiranScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          'Laporan Permintaan Koreksi Kehadiran',
          style: AppTextStyles.h4(colors.textPrimary),
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildLabel(colors, 'Jenis Status'),
            SizedBox(height: 4.h),
            GestureDetector(
              onTap: _showStatusBottomSheet,
              child: _buildTextField(
                colors,
                hint: _selectedStatus == null || _selectedStatus == 'Pilih'
                    ? 'Pilih'
                    : _selectedStatus!,
