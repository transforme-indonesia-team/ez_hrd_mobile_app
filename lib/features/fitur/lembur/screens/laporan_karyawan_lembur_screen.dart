...
class LaporanKaryawanLemburScreen extends StatefulWidget {
  const LaporanKaryawanLemburScreen({super.key});

  @override
  State<LaporanKaryawanLemburScreen> createState() =>
      _LaporanKaryawanLemburScreenState();
}

class _LaporanKaryawanLemburScreenState
    extends State<LaporanKaryawanLemburScreen> {
