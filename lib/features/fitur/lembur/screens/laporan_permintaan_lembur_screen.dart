...
class LaporanPermintaanLemburScreen extends StatefulWidget {
  const LaporanPermintaanLemburScreen({super.key});

  @override
  State<LaporanPermintaanLemburScreen> createState() =>
      _LaporanPermintaanLemburScreenState();
}

class _LaporanPermintaanLemburScreenState
    extends State<LaporanPermintaanLemburScreen> {
  DateTimeRange? _selectedDateRange;
  List<MemberData> _selectedEmployees = [];
  String? _selectedStatusPermintaan;

  final List<String> _statusPermintaanOptions = [
    'Pilih',
    'Disetujui',
    'Menunggu',
    'Ditolak',
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildLabel(colors, 'Status Permintaan'),
            SizedBox(height: 4.h),
            GestureDetector(
              onTap: () {
                _showDropdownBottomSheet(
                  title: 'Pilih Jenis Permintaan',
                  options: _statusPermintaanOptions,
                  onSelected: (val) =>
                      setState(() => _selectedStatusPermintaan = val),
                );
              },
              child: _buildTextField(
                colors,
                hint: _selectedStatusPermintaan == null ||
                        _selectedStatusPermintaan == 'Pilih'
                    ? 'Pilih Jenis Permintaan'
                    : _selectedStatusPermintaan!,
