...
class DynamicFieldModel {
  ...
  DynamicFieldModel({this.label = '', this.type = 'Pilih Jenis Masukan'});
}

class BuatJenisTugasScreen extends StatefulWidget {
  const BuatJenisTugasScreen({super.key});

  @override
  State<BuatJenisTugasScreen> createState() => _BuatJenisTugasScreenState();
}

class _BuatJenisTugasScreenState extends State<BuatJenisTugasScreen> {
  final TextEditingController _nameController = TextEditingController();
  final List<DynamicFieldModel> _dynamicFields = [];

  void _addField() {
    setState(() {
      _dynamicFields.add(DynamicFieldModel());
    });
  }
          ...
          child: Column(
            ...
            children: [
              ...
              TextField(
                ...
                style: AppTextStyles.body(colors.textPrimary),
                decoration: InputDecoration(
                  hintText: 'Masukkan Nama Jenis Tugas',
                  hintStyle: AppTextStyles.body(colors.textSecondary),
                  filled: true,
                  fillColor: colors.background,
                  contentPadding: EdgeInsets.symmetric(horizontal: 12.w, vertical: 12.h),
